...
namespace OvhApi.Models.Telephony {
	...
	public sealed class BillingAccount {
		...
		[JsonProperty("status")]
		private OvhApi.Models.Telephony.BillingAccountStatusEnum _status;
		...
		/// 
		/// </summary>
		public OvhApi.Models.Telephony.BillingAccountStatusEnum Status {
			get {
				return this._status;
			}
		}
	...
	/// <summary>
	/// Give the billing account status
	/// </summary>
...
namespace OvhApi.Models.Xdsl {
	...
	public sealed class AccessDiagnostic {
		...
		/// <summary>
		/// Physical line test from our equiments
		/// </summary>
