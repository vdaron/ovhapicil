...
namespace OvhApi.Models.Hosting.Web {
	...
	public sealed class AttachedDomain {
		...
		/// <summary>
		/// Domain's path, relative to your home directory
		/// </summary>
		public string Path {
			get {
				return this._path;
...
namespace OvhApi.Models.Hosting.Web {
	...
	public sealed class Module {
		...
		public sealed class DependencyType {
			...
			[JsonProperty("action")]
			private OvhApi.Models.Hosting.Web.Module.DependencyActionEnum _action;
			...
			/// <summary>
			/// Set wether to automatically create a new database for you or use one that already exist
			/// </summary>
			public OvhApi.Models.Hosting.Web.Module.DependencyActionEnum Action {
				get {
					return this._action;
				}
				set {
		...
		/// <summary>
		/// Whether the dependency is created or used
		/// </summary>
